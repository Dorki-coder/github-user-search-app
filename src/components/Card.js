...
export default function Card({ theme, data, isLoading }) {
  console.log(data);

  console.log();
  return Object.keys(data).length > 0 && data.message !== "Not Found" ? (
    <div className="card">
      {isLoading === true ? (
        ...
        <>
          ...
          <div className="user__description">
            <div className="card__title">
              <h1>{data.name}</h1>
              <span className="card__login">{"@" + data.login}</span>
              <p className="card__title-date">
            ...
            <div className="card__links">
              ...
              <a href={data.html_url}>
                <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                  <g fill={theme === "dark" ? "#FFFFFF" : "#4b6a9b"}>
                ...
                {data.html_url === "" ? "not found" : data.html_url}
              </a>
              <p>
                <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                  <g fill={theme === "dark" ? "#FFFFFF" : "#4b6a9b"}>
